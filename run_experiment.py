"""Main experiment runner for temperature awareness testing."""
...
from prompts import get_direct_prompts, get_warmup_prompt
...
def run_experiment() -> list[dict]:
    ...
    results = []
    direct_prompts = get_direct_prompts()
            ...
            for temp in TEMPERATURES:
                for n in N_VALUES:
                    for prompt_set_idx in range(PROMPTS_PER_N):
                        ...
                        prompt = get_warmup_prompt(questions)
...
def main():
    print("=" * 60)
    print("Temperature Awareness Experiment")
    print("=" * 60)
